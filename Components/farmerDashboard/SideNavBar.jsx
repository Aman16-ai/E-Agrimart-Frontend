...
export default function SideNavBar() {
  ...
  {isHovered ? <button className={`mt-auto mb-[15px] bg-blue-500 w-48 rounded-md text-white h-10 rounded-2xl}`}><LogoutIcon/> Logout</button> : <div className='mt-auto mb-[15px] shadow-md w-12 h-10 flex justify-center items-center rounded-md'><LogoutIcon/></div>}
    </div>
    );
}