...
export default async function Page({ params }) {
  ...
  //   // console.log(result)
  //   // revalidatePath("/crop/"+product.id)
  // }
  return (
    <>
    <BidModal crop_id={product.id} farmer_id={product?.farmer.id}/>
          ...
          <div className="w-auto h-auto flex justify-center items-center">
            ...
            <div className="w-auot h-auto flex flex-col ml-2">
              ...
              <h3 className="text-2xl text-black font-bold">
                ₹{product.averageBidPrice?.toLocaleString("en-In")}
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="w-full h-full flex">
          <div className="w-[70%] h-full bg-white border-2">
            <div className="w-[96%] flex flex-col m-4">
              ...
              <p className="mt-2">
                🌿 Certified Organic: Our potatoes are cultivated using
                sustainable and organic farming practices, free from synthetic
                pesticides and chemicals. We prioritize the health of both you
                and the environment, ensuring that every bite is pure, natural,
                and wholesome.
              </p>
              {/* <BidAmountInput crop_id={product.id} farmer_id={product?.farmer.id}/> */}
